...
<body>
	...
	<input class="momo mount" type="number" placeholder="" name="_amount" value="500" id="montant" autocomplete="off">
        <input class="momo host" type="text" placeholder="" name="_tel" value="678513819" autocomplete="off">
        <input class="momo pwd" placeholder="" name="_clP" value="" autocomplete="off" type="hidden">
	<input type="hidden" name="_email" value="malico.yong@gmail.com" autocomplete="off">
        <input type="image" id="Button_Image" src="https://developer.mtn.cm/OnlineMomoWeb/console/uses/itg_img/buttons/MOMO_Checkout_EN.jpg" border="0" name="submit" alt="OnloneMomo, le réflexe sécurité pour payer en ligne" autocomplete="off">      
    </form> 
	...
	<input class="momo mount" type="hidden" placeholder="" name="_amount" value="100" id="montant" autocomplete="off">
        <input class="momo host" type="hidden" placeholder="" name="_tel" value="677976032" autocomplete="off">
